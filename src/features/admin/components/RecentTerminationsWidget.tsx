  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <h2 className="font-bold">Bajas recientes</h2>
      </div>
      <ul className="space-y-2">
        {items.map((item) => (
          <li className="flex items-center gap-3" key={item.id}>
            <span className="grid size-9 shrink-0 place-items-center rounded-full bg-red-100 text-[10px] font-bold text-red-700">
