  ...
  return (
    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <h2 className="font-bold">Top solicitantes ({months}m)</h2>
      </div>
      <ul className="space-y-2">
        {ranked.map(({ m, count }) => (
          <li className="flex items-center gap-3" key={m.id}>
            <span className="grid size-8 shrink-0 place-items-center rounded-full bg-indigo-100 text-[10px] font-bold text-indigo-700">
