...
export function OfflineBanner() {
  ...
  return <div aria-live="assertive" className="fixed inset-x-0 top-0 z-[100] flex min-h-11 items-center justify-center gap-2 bg-amber-400 px-4 text-center text-sm font-black text-amber-950" role="status"><WifiOff aria-hidden="true" className="size-4" />Sin conexión. Mostraremos la información guardada.</div>;
}
