    ...
    return (
      <main className="grid min-h-dvh place-items-center bg-slate-50 px-6 text-center" role="alert">
        <section className="w-full max-w-sm">
          <h1 className="text-2xl font-bold text-[var(--color-text)]">Algo falló</h1>
          <p className="mt-2 text-sm leading-6 text-[var(--color-muted)]">
            Ocurrió un error inesperado. Recarga la app para continuar.
          </p>
          <button
            className="press mt-6 inline-flex min-h-11 w-full items-center justify-center rounded-full bg-slate-950 px-5 text-sm font-bold text-white"
            type="button"
